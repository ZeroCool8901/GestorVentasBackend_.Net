...
namespace GestorVentas_Backend.Controllers
{
    ...
    public class BankAccountsController : ControllerBase
    {
        ...
        public BankAccountsController(GestorVentasContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<BankAccount>> PostBankAccount(BankAccount bankAccount)
        {
          if (_context.BankAccounts == null)
          {
              return Problem("Entity set 'GestorVentasContext.BankAccounts'  is null.");
          }
        ...
        {
            return (_context.BankAccounts?.Any(e => e.IdBankAccount == id)).GetValueOrDefault();
        }
    }
}
